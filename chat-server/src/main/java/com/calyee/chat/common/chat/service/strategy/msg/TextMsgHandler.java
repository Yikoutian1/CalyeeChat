...
import com.calyee.chat.common.chat.domain.vo.response.msg.TextMsgResp;
...
import com.calyee.chat.common.common.utils.discover.PrioritizedUrlDiscover;
import com.calyee.chat.common.common.utils.discover.domain.UrlInfo;
...
//        update.setContent(sensitiveWordBs.filter(body.getContent()));
        update.setContent(body.getContent());//todo: 这里少了一个敏感词检测以后可以加上
